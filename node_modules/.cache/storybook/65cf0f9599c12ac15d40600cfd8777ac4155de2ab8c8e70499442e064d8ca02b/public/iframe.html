    ...
    console.warn('unable to connect to top frame for connecting dev tools');
      ...
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./components","files":"**/stories.tsx","importPathMatcher":"^\\.[\\\\/](?:components(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)stories\\.tsx)$"}];
      ...
      import './vendors-node_modules_storybook_addon-docs_dist_preview_mjs-node_modules_storybook_react_dist_-2a1e79.iframe.bundle.js';
